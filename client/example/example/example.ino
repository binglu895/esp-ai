...
void setup() {
  ...
  // 用开发者平台，只需要配置为空
  //ESP_AI_server_config server_config = { "192.168.1.5", 8088, "api-key=c99a159044564499a630c962e26448e9&p2=test" };
  ...
  //ASR PRO (MIC red@+, SPK red@+, PB5@rx, PB6@tx, gdn@gdn, 5v@vin)
  

  // [可留空] 麦克风引脚配置：{ bck_io_num, ws_io_num, data_in_num }
  //ESP_AI_i2s_config_mic i2s_config_mic = { 14, 13, 12 };
